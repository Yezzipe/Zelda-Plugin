...
public class PathfinderGoalMeleeAttackCustom extends PathfinderGoal {
  ...
  public boolean a() {
    ...
    if (this.path != null)
      return true; 
    if (getAttackReachSqr(var2) >= this.mob.h(var2.dc(), var2.de(), var2.di()))
      return true; 
    return false;
  }
  ...
  public void e() {
    ...
    double var1 = this.mob.h(var0.dc(), var0.de(), var0.di());
    this.ticksUntilNextPathRecalculation = Math.max(this.ticksUntilNextPathRecalculation - 1, 0);
    if ((this.followingTargetEvenIfNotSeen || this.mob.E().a((Entity)var0)) && 
      this.ticksUntilNextPathRecalculation <= 0 && ((
      this.pathedTargetX == 0.0D && this.pathedTargetY == 0.0D && this.pathedTargetZ == 0.0D) || var0.h(this.pathedTargetX, this.pathedTargetY, this.pathedTargetZ) >= 1.0D || this.mob.dL().nextFloat() < 0.05F)) {
      this.pathedTargetX = var0.dc();
      this.pathedTargetY = var0.de();
      this.pathedTargetZ = var0.di();
      this.ticksUntilNextPathRecalculation = 4 + this.mob.dL().nextInt(7);
      if (var1 > 1024.0D) {
  ...
  private void customHurt(Entity entity) {
    ...
    if (flag && 
      f1 > 0.0F && entity instanceof EntityLiving) {
      ((EntityLiving)entity).p((f1 * 0.5F), MathHelper.a(this.mob.dn() * 0.017453292F), -MathHelper.b(this.mob.dn() * 0.017453292F));
  ...
  protected double getAttackReachSqr(EntityLiving var0) {
    return (this.mob.cT() * 2.0F * this.mob.cT() * 2.0F + var0.cT());
  }
}
