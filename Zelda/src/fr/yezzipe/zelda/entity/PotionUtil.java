...
public class PotionUtil {
	...
	public static Collection<PotionEffectMemory> merge(Collection<PotionEffectMemory> base, Collection<PotionEffectMemory> fuse) {
		if (fuse == null || fuse.isEmpty()) return base;
