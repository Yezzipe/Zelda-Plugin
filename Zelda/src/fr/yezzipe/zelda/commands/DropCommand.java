      ...
      if (arg3.length == 5) {
        if (arg3[0].equals("absolute")) {
          ...
          if (Main.isInt(arg3[2]) && Main.isInt(arg3[3]) && Main.isInt(arg3[4])) {
            Location loc = new Location(p.getWorld(), Integer.parseInt(arg3[2]), Integer.parseInt(arg3[3]), Integer.parseInt(arg3[4]));
          ...
          ItemStack item = DropBuilder.build(drop);
          if (Main.isInt(arg3[2]) && Main.isInt(arg3[3]) && Main.isInt(arg3[4])) {
            Location loc = new Location(p.getWorld(), p.getLocation().getX() + Integer.parseInt(arg3[2]), p.getLocation().getY() + Integer.parseInt(arg3[3]), p.getLocation().getZ() + Integer.parseInt(arg3[4]));
            p.getWorld().dropItem(loc, item);
          } else {
            arg0.sendMessage("§cWrong Syntax in Command");
          } 
