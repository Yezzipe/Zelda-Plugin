...
public class ItemBuilder {
	...
	public static void init() {
		...
		ShapedRecipe grappling = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "grappling-hook"), grappling_item);
		...
		ShapedRecipe light_bow = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "light-bow"), light_bow_item);
		...
		ShapedRecipe dark_bow = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "dark-bow"), dark_bow_item);
		...
		ShapedRecipe ice_bow = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "ice-bow"), ice_bow_item);
		...
		ShapedRecipe fire_bow = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "fire-bow"), fire_bow_item);
		...
		ShapedRecipe heart_container_recipe_1 = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "heart-container-1"),
				heart_container);
		ShapedRecipe heart_container_recipe_2 = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "heart-container-2"),
				heart_container);
		ShapedRecipe heart_container_recipe_3 = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "heart-container-3"),
				heart_container);
		ShapedRecipe heart_container_recipe_4 = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "heart-container-4"),
				heart_container);
		...
		ShapedRecipe shadow_crystal_recipe = new ShapedRecipe(new NamespacedKey((Plugin) Main.getInstance(), "shadow-crystal"),
				shadow_crystal);
