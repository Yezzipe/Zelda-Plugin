...
public class CustomNPC extends EntityVillager {
  ...
  public static CustomNPC CustomGuardNPC(EntityTypes<? extends EntityVillager> entitytypes, World world, @Nullable Location loc) {
    ...
    npc.bS.a(9, (PathfinderGoal)new PathfinderGoalLookAtPlayer((EntityInsentient)npc, EntityHuman.class, 4.0F, 1.0F));
    npc.bS.a(8, (PathfinderGoal)new PathfinderGoalRandomLookaround((EntityInsentient)npc));
    if (loc != null)
      npc.bS.a(7, new PathfinderGoalRandomStrollStayNear((EntityCreature)npc, loc, 0.6D, 7.0D)); 
    npc.bS.a(1, new PathfinderGoalMeleeAttackCustom((EntityCreature)npc, 0.6D, false));
    npc.bS.a(2, (PathfinderGoal)new PathfinderGoalMoveTowardsTarget((EntityCreature)npc, 0.6D, 0.5F));
    npc.bT.a(1, (PathfinderGoal)new PathfinderGoalNearestAttackableTarget<EntityInsentient>((EntityInsentient)npc, EntityInsentient.class, 0, true, true, entityliving -> entityliving instanceof net.minecraft.world.entity.monster.IMonster));
    return npc;
  }
