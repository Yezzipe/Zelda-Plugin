...
public class PathfinderGoalMeleeAttackCustom extends PathfinderGoal {
  ...
  public void e() {
    ...
    if ((this.followingTargetEvenIfNotSeen || this.mob.E().a((Entity)var0)) && 
      this.ticksUntilNextPathRecalculation <= 0 && ((
      this.pathedTargetX == 0.0D && this.pathedTargetY == 0.0D && this.pathedTargetZ == 0.0D) || var0.h(this.pathedTargetX, this.pathedTargetY, this.pathedTargetZ) >= 1.0D || this.mob.dQ().i() < 0.05F)) {
  ...
  private void customHurt(Entity entity) {
    ...
    if (flag && 
      ...
      ((EntityLiving)entity).p((f1 * 0.5F), MathHelper.a(this.mob.dq() * 0.017453292F), -MathHelper.b(this.mob.dq() * 0.017453292F));
